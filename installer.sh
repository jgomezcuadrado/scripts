...
sudo apt install awscli default-jdk python3-pip python3-dev python3-setuptools netcat -y
...
jupyter lab --NotebookApp.token='' --no-browser --ip "*" --allow-root --NotebookApp.notebook_dir = '/tmp'& 
